...
var markdown = require('@ts-stack/markdown');
...
var DMPBlurb = function DMPBlurb(_ref) {
  ...
  return React__default.createElement(StyledDMLBlurb, {
...
var DMPContent = function DMPContent(_ref) {
  var children = _ref.children;
  return React__default.createElement(StyledDMPContent, {
...
var DMPExample = function DMPExample(_ref) {
  ...
  label = label || 'Example';
  return React__default.createElement(StyledDMLExample, {
    className: 'dmp__example'
  }, React__default.createElement("h2", null, label), React__default.createElement(StyledDMPCodeWrap, {
    className: 'dmp_code-wrap'
  }, React__default.createElement(StyledDMPCodePre, null, React__default.createElement(StyledDMPCode, {
...
var DMPFooter = function DMPFooter(_ref) {
  ...
  return React__default.createElement(StyledDMLFooter, {
...
var DMPGHLink = function DMPGHLink(_ref) {
  ...
  })), React__default.createElement(StyledDMPGHLinkText, {
...
var DMPHeader = function DMPHeader(_ref) {
  var children = _ref.children;
  return React__default.createElement(StyledDMPHeader, {
...
var DMPInstall = function DMPInstall(_ref) {
  var name = _ref.name;
  return React__default.createElement(StyledDMPInstall, {
    className: 'dmp__install'
  }, React__default.createElement("h2", null, "Install"), React__default.createElement(StyledDMPCodeWrap$1, {
    className: 'dmp_code-wrap'
  }, React__default.createElement(StyledDMPCode$1, {
    className: 'dmp_code'
  }, "npm install ", name, " --save")), React__default.createElement(StyledDMPCodeWrap$1, {
    className: 'dmp_code-wrap'
  }, React__default.createElement(StyledDMPCode$1, {
    className: 'dmp_code'
  }, "yarn add ", name)));
...
var DMPLogo = function DMPLogo(_ref) {
  ...
  return React__default.createElement(StyledDMPLogo, {
    className: 'dmp__logo'
  }, name);
};
...
var parseTable = function parseTable(table) {
  ...
  var html = parse(markdown.Marked.parse(table).replace(/>\s/g, '>'));
  return html;
};
...
var DMPTable = function DMPTable(_ref) {
  ...
  addCellClasses();
  return React__default.createElement(StyledDMPTable, {
    className: 'dmp__table'
  }, React__default.createElement("h2", null, name), React__default.createElement(StyledDMPTableWrap, null, html));
};
...
var DMPWrap = function DMPWrap(_ref) {
  var children = _ref.children;
  return React__default.createElement(StyledDMPWrap, {
    className: 'dmp__wrap'
  }, children);
};

exports.DMPBlurb = DMPBlurb;
exports.DMPContent = DMPContent;
exports.DMPExample = DMPExample;
exports.DMPFooter = DMPFooter;
exports.DMPGHLink = DMPGHLink;
exports.DMPHeader = DMPHeader;
exports.DMPInstall = DMPInstall;
exports.DMPLogo = DMPLogo;
exports.DMPTable = DMPTable;
exports.DMPWrap = DMPWrap;
